    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= base_url("/logout") ?>" class="nav-link btn btn-primary btn-sm" onclick="return confirm('Do You Want to Logout this Session?')" style="color:#fff" ;>Logout</a>
        </li>
      </ul>
        ...
        <li class="nav-item">
          <div class="text-center ">
            <div class="ml-5">
              <h3><?php
                  $db = db_connect();
                  $query = $db->query('SELECT name FROM tbl_settings');
                  $result = $query->getRow();
