            ...
            <div class="col-md-12 ">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Add Milk Collection</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body">
                    ...
                    <form autocomplete="off" action="<?= base_url('/milk/add') ?>" method="POST">
                        <div class="card-body row">
                            ...
                            <div class="form-group col-xl-4 col-12">
                                <label>Shift*:</label>
                                <select class="form-control select2" style="width: 100%;" id="shift" name="shift" onchange="getPrice()">
                            ...
                            <div class="form-group col-xl-4 col-12">
                                ...
                                <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Enter Quantity" onkeyup="getPrice()">
                            ...
                            <div class="form-group col-xl-4 col-12">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="fat" id="fat" onchange="getPrice()">
                                    ...
                                    <?php foreach ($fat as $fat_1) { ?>
                                        <option value="<?= $fat_1->id ?>"><?= $fat_1->fat ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group col-xl-4 col-12">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="cnf" id="cnf" onchange="getPrice()">
                                    ...
                                    <?php foreach ($cnf as $cnf_1) { ?>
                                        <option value="<?= $cnf_1->id ?>"><?= $cnf_1->cnf ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group col-xl-4 col-12">
                                ...
                                <input type="number" id="per_liter_price" name="per_liter_price" class="form-control" readonly>
                            </div>
