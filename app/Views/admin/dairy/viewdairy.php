            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="<?= base_url("/dairy/create") ?>">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row->dairy_mobile; ?></td>
                                        <td><?= $row->dairy_address; ?></td>
                                        <td>
                                            <a href="<?= base_url('dairy/edit/' . $row->id) ?>" class="btn btn-primary btn-sm mr-3">Edit</a>
                                            <a href="<?= base_url('dairy/delete/' . $row->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Do You Want to Delete?')">Delete</a>
                                        </td>
