            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="<?= base_url("/category/create") ?>">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row->status; ?></td>
                                        <td>
                                            <a href="<?= base_url('category/edit/' . $row->id) ?>" class="btn btn-primary btn-sm mr-3">Edit</a>
                                            <a href="<?= base_url('category/delete/' . $row->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Do You Want to Delete?')">Delete</a>
                                        </td>
